    ...
    <div class="flex">
      ...
      <div class="border-2 border-gray-300 rounded p-4">
        ...
        <div class="flex items-center mb-4">
          <div class="mr-2">
            <input type="text" placeholder="Nombre" class="border border-gray-300 px-3 py-2 rounded w-32">
          </div>
          <div class="mr-2">
            <input type="text" placeholder="Apellido" class="border border-gray-300 px-3 py-2 rounded w-32">
          </div>
          <div class="mr-2">
            <input type="tel" placeholder="Teléfono" class="border border-gray-300 px-3 py-2 rounded w-32">
          </div>
        </div>
        ...
        <div class="flex items-center mb-4 w-full">
          <div class="mr-4 w-full">
            <input type="email" placeholder="Correo electrónico" class="border border-gray-300 px-3 py-2 rounded w-full">
          </div>
        </div>
